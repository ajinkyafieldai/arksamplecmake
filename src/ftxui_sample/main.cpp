...
// configuration step. It creates a namespace called `arksamplecmake`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", arksamplecmake::cmake::project_name, arksamplecmake::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", arksamplecmake::cmake::project_version);
      return EXIT_SUCCESS;
    }
